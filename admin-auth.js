/* Guarda de acesso ao painel interno.
   ...
   digitar a senha em admin.html antes de qualquer dado aparecer).
   ...
   Troque a senha abaixo antes de divulgar o link do admin.html. */
...
export const sair = () => { sessionStorage.removeItem(CHAVE); location.href = 'admin.html'; };
...
/* Chame isso no topo de qualquer página que só o time pode ver, antes
   ...
   enquanto a navegação para admin.html ainda está em andamento. */
